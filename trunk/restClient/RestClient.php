...
class RestClient {
      ...
      * @return RestClient
      */
     public static function get($url,array $params=null,$user=null,$pwd=null,$contentType=null,$headers) {
         return self::call("GET",$url,$params,$user,$pwd,$headers);
     }
      ...
      * @return RestClient
      */
     public static function call($method,$url,$body,$user=null,$pwd=null,$contentType=null,$headers=array()) {
